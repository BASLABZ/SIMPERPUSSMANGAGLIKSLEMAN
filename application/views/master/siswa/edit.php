...
<div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Ubah Siswa / Aggota 
                ...
                <?php echo validation_errors( "<div class='alert alert-danger alert-dismissable'><button aria-hidden='true' data-dismiss='alert' class='close' type='button'>×</button>", "</div>"); ?>
                   <?php 
                    foreach ($data as  $value) :
                      ...
                      $gender       = $value['gender'];
                      $siswa_kontak = $value['siswa_kontak'];
                    
                 ?>
                 <?php echo form_open( 'master/siswa/proses_edit/'.$value['siswa_id'],[ 'class'=> 'role', 'id' => 'validform']) ?>
                 <div class="form-group">
                   <label>Kode Siswa / Aggota </label>
                   <input  type="text" name="siswa_id" class="form-control" readonly value="<?php echo $siswa_id; ?> "  >
                 </div>
                 <div class="form-group">
                   <label>NIS</label>
                 ...
                 <div class="form-group">
                   <label>Kontak</label>
                   <input type="text" class="form-control" name="siswa_kontak" placeholder="kontak" required=""  value="<?php echo $siswa_kontak; ?>" />
                 </div>
                 <div class="form-group">
